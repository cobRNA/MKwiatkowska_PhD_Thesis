...
my @biotypePriority=("antisense", "IG_C_gene", "IG_C_pseudogene", "IG_J_pseudogene", "IG_pseudogene", "IG_V_pseudogene", "lincRNA", "miRNA", "misc_RNA", "Mt_rRNA", "Mt_tRNA", "polymorphic_pseudogene", "processed_pseudogene", "processed_transcript", "protein_coding", "pseudogene", "ribozyme", "rRNA", "scaRNA", "sense_intronic", "sense_overlapping", "snoRNA", "snRNA", "sRNA", "TEC", "transcribed_unprocessed_pseudogene", "TR_D_gene", "TR_J_gene", "TR_V_gene", "TR_V_pseudogene", "unprocessed_pseudogene");
